...
If you would like to get involved, here you can find a brief division of labor within organising committee.
...
grid.raster(img)
```
In 2019-2020 we were able to *organise X events covering x workshops, x seminars and x networking*. We have had some amazing experience, such as teaching R practically to high school girls, hosting speakers from the editorial borad of rOpensSci and from RStudio, as well as receiving the Kelleway Excellence for Eduation Award from the Walter and Eliza Hall Institute of Medical Research. Now, I explain more about different events we have had in the past year and highlight some of our amazing experience with the R-Ladies speakers and members.
# Encouraging high school girls (note from GG - this event is one of the important contributions to the community. It can be be good if you add some of your personal experiences and opinions on the potential impact on girls.)
...
The R-Ladies Melb Inc was excited to have Goknur Giner, co-founder of R-Ladies Melbourne, presenting about basics of RShiny during our third year anniversary event. Just to add a personal view on this, I started making RShiny apps after her super-clear talk on that day. We had an R-Ladies-themed cake with all the amazing members attended on the day and enjoyed a fantastic view from the NOUS venue. Morever, as I shared the great joy of founding this group with her, the moments Goknur talked about her journey with R-Ladies Melbourne were particularly sentimental to me. Her appreciation for the support she received from us as a community after she became a mother indicated that there are many other aspects of how R-Ladies Melbourne can assist individuals. Her daughter Maya Su is 2,5 years old now and she has already been to two useR! conferences. As Goknur mentioned in her talk, thanks to the R-Ladies community all around the world for creating opportunities for women.   
...
Although useR 2018 was in Brisbane and most of our organisers could attend and present at it, the **useR 2019** was in July 2019 in *[Toulouse, France] (http://www.user2019.fr/) * and therefore harder for the organisers to attend that. However, it was fantastic to see that a past (Roxane) and a present (Goknur) R-Ladies Melb organisers could still meet up at the [useR! 2019] (https://twitter.com/RLadiesGlobal/status/1148937344214605824/photo/1) - (note from GG - here I added the link for the photo below. If you can compile the photo, then you can remove this link sweetie). 
```{r, echo=FALSE, fig.cap="The useR! 2019 R-Ladies Global with Goknur and Roxane",echo=FALSE, fig.align="center", out.width = '95%'}
img <- readPNG("./photos/r-ladiesTolouse.png")
grid.raster(img)
```
