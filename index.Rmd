...
Perhaps it was not surprising that this event was the biggest event the R-Ladies Melb organised to date. We had about 130 attendees and many people in the waiting list. That is why we live-streamed the event so that other people could join us too. We owe this to the amazing **Eike Germann** from [Eliiza](https://twitter.com/EliizaAI), who helped us filming the event and streaming that to our Youtube channel.
...
**It has not been just about R!** This has been also about ourselves, our barriers and challenges. I believe the R-Ladies is a family where people offer support to each other! Sometimes this support is in the form of workshop or seminars, where people develop skills, which in turn contributes to a [more inclusive data science world](https://qz.com/work/1661486/r-ladies-made-data-science-inclusive/), but other times, this support is in the form of friendship. I have experienced enormous amount of mental support from the members of R-Ladies Melb, particularly when I was hospitalised due to an accident and it was quite difficult to get back to rutine. I know other members in the team, such as Goknur as mentioned above, also benefited from the friendly and supportive environment in this family.
