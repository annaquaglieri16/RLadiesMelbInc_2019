...
We are thrilled to be have been nominated for the **Kellaway Excellence Award for Education** by **Gordon Smyth** from WEHI, and very honored to have received this group award in Dec 2019. This is perhaps the first time that all the efforts of R-Ladies Melb has been officially recognised by an institute, and it feels incredibly great to have the support from the Bioinformatics co-division head and the director of WEHI, **Doug Hilton**. 
...
grid.raster(img)
```
**[Di Cook](https://twitter.com/visnut?s=20)** has always supported the R-Ladies Melb team all along the way. In mid 2019 she let us know that [Hadley](https://twitter.com/hadleywickham) will be in Melb later in the year and so we could invite him straight away! Hadley's talk focused on designing data science. 
Perhaps it was not surprising that this event was the biggest event the R-Ladies Melb has organised to date. We had about 130 attendees and many people in the waiting list. That is why we live-streamed the event so that other people could join us too. We owe this to the amazing **Eike Germann** from [Eliiza](https://twitter.com/EliizaAI), who helped us filming the event and streaming that to our Youtube channel.
...
If there are things that we are not sure about, we can always ask the other R-Ladies chapters on the slack channel, specifically, the **[R-Ladies Global](https://rladies.org)**. It is important to remember that all we do is voluntary and therefore there is no pressure to have so many events in a year; the more we can do, the more we enjoy supporting the under-represented poeple in the R community, which is a great cause and is truly rewarding.
