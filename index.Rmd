...
Over the last three years, The R-Ladies Melb has had growing number of members, and today we are glad to have close to 1400 members in our local community; this shows the existing need for an inclusive group for women and people of minority genders in the R community. 
The R-Ladies Melb had an amzing year in 2019; we registered the R-Ladies Melb as an incorporation, received the Kelleway Excellence for Eduation Award from WEHI, hosted amazing speakers, such as Alison and Hadley from RStudio and Melina from the editorial borad of rOpensSci, and contributed in teaching to high school girls. Below are the highlights of R-Ladies Melb in 2019!

# R-Ladies Melb is now a registered not-for-profit!
As briefly mentioned [before](https://r-ladiesmelbourne-team.netlify.com), we started to learn about how to become an incoporated association over the last few months of 2018. Several members of the team started reading about this and collecting information, specifically [Anna Quaglieri](https://twitter.com/annaquagli), [Lucy Liu](https://twitter.com/lucyleeow) and [myself](https://twitter.com/S_Foroutan). Finally, in a lovely afternnon on the 29th of March, Lucy and I registered the **R-Ladies Melb Inc** through [myCAV for incorporated association](https://www.consumer.vic.gov.au/clubs-and-fundraising/incorporated-associations/mycav-for-incorporated-associations). This required us to define official roles, specifically for president, vice-presidet, treasurer and secretary. Then, we started learning how to open a bank account for incorporation and how to spend expenses and keep track of them more formally. A lot of these were done by [Adele Barugahare](https://twitter.com/technadele) who became our treasurer and [Marie Trussart](https://twitter.com/MTrussart), who was selected as vice-president in mid 2019 after our initial vice-president, [Nikki Rubinstein](https://twitter.com/nikkirubinstein), stepped down from that role due to other committment. [Goknur Giner](https://twitter.com/goknurginer) agreed to become the secretary after our intial secretary, Lucy, left Australia in May 2019; finally, I took the role of president.
...
We are thrilled to be nominated for the **Kellaway Excellence Award for Education** by **Gordon Smyth** from WEHI, and very honored to have received this group award in Dec 2019. This is perhaps the first time that all the efforts of R-Ladies Melb has been officially recognised by an institute, and it feels incredibly great to see the support from the Bioinformatics co-division head and the director of WEHI, **Doug Hilton**. 
...
This year, we were luckly to have two speakers from the RStudio: **Alison Hill** in Sep 2019 and **Hadley Wickham** in Nov 2019. [Alison Hill](https://twitter.com/apreshill?s=20) showed us how to take a bad plot and make it better! She gave an example of her work on a book and how she made the same figure every time better! All of the attendees of that night also said a hi to Alison's little daughtor on the [video](https://twitter.com/apreshill/status/1179714814160957440?s=20) that she recorded! 
...
grid.raster(img)
```
**[Di Cook](https://twitter.com/visnut?s=20)** has always supported the R-Ladies Melb team all along the way. In Mid 2019 she let us know that Hadley will be in Melb later in the year and so we could invite him straight away! Hadley's talk focused on designing data science. 
Perhaps it was not surprising that this event was the biggest event the R-Ladies Melb organised to date. We had about 130 attendees and many people in the waiting list. That is why we live-streamed the event so that other people could join us too. We owe this to the amazing **Eike Germann** from [Eliiza](https://twitter.com/EliizaAI), who helped us filming the enevt and streaming that to our Youtube channel.
...
Live streaming this event was extramely useful, and we had local and international people who could join us. Hadley not only covered materials related to the data science and importance of design, but also emphasized that people would better learn through making mistakes and in a supportive environment. It was also fantastic to hear that he has given many talks at different R-Ladies groups and that he believes the R-Ladies has made a supportive and friendly environment for people to learn. 
As we had so many people attending this event, we asked them to bring their own cup to minimise the waste. You can still watch [his talk on our Youtube](https://www.youtube.com/watch?v=bNVcDETgS54).
...
We were invited in participating in the **“It takes a spark”** conference organized by Spark EDU in Sep 2019. This conference program is intended for both teachers and students to raise awareness and interest of high-school girls and connect with inspiring female role models. We organized a workshop on solving an outbreak using data analysis and programming skills. **Our goal was to empower high school girls and their teachers to learn how to code in R and solve a disease outbreak**. It was a great success as our workshop was booked out and it was a really rewarding experience that we thoroughly enjoyed thanks to the enthusiasm of the students to learn and solve all the exercises. 
...
To be an organisers of R-Ladies Melb, you do not need to be expert in R, use R every day, and spend a lot of time organising things, etc; you can be an R-Ladies organiser if you are passionate about R, supportive of diversity in the R community, keen to help out with event organisation and have a bit of spare time. If you would like to get involved, here you can find a brief description of labor within organising committee based on my experience. 
...
For each role, we have a main person responsible for that role as well as a secondary person that covers that responsibility in the absence of the main person. Alternatively, the two persons can share the responsibility as suits them. For example, Nikki and Shazia are responsible for twitter but for the events that Nikki was not around, Shaiza was the person doing the live-tweeting. They also check the R-Ladies Melb twitter account in turn. 
...
If there are things that we are not sure about, we can always ask the other R-Ladies chapters on the slack channel, specifically, the **[R-Ladies Global](https://rladies.org)**. It is important to remember that all we do is voluntary and therefore there is no pressure to have so many events in a yeat; the more we can do, the more we enjoy supporting the under-represented poeple in the R community, which is a great cause and is truly rewarding.

If you think this is something that fits you and your schedules, please get in touch! The R-Ladies Melb always needs motivated and passionate organisers! 
...
It was a great but challenging experience to lead the team as the president. As a perfectionist, I always used to do everything myself, and so it was not easy to **delegate work to people**, but I am glad that I learnt this with help from other members, specifically, Marie and Goknur. One thing that I used to do naturally though, was that I always **ask the committee members' opinions** on matters as it gave me a feeling that everyone is happy with a decision. 

**It has not been just about R!** This has been also about ourselves, our barriers and challenges. I believe the R-Ladies is a family where people offer support to each other! Sometimes this support is in the form of workshop or seminars, where people develop skills, which in turn contributes to a [more inclusive data science world](https://qz.com/work/1661486/r-ladies-made-data-science-inclusive/), but other times, this support is in the form of friendship. I have experienced enourmouse amount of mental support from the members of R-Ladies Melb, particularly when I was hospitalised due to an accident and it was quite difficult to get back to rutine. I know other members in the team, such as Goknur as mentioned above, also benefited from the friendly and supportive environment in this family.

Based on all the great experience that I have personally had as part of this community, **I strongly encourage you to consider joining the group as a co-organiser**. You can learn so much by doing so and see how rewarding it is! You will also be recognised for your contribution as we were, and of course it looks good on your CV! I am sure you will love being a part of this community, as we all do. 

In the end, I would like to thank every one of the past and present **organisers** of R-Ladies, all our great **speakers** who shared their knowledge with our community in order to get them started using/making tools or advance their skills. It is obvious that without the **members in our local community** we would not be able to continue, and without the support that we get from the larger **community of R-Ladies** around the world we could not develop over time. It has been always the members' enthusiasm and the community's support that encouraged us to continue. THANK YOU!!
...
```{r, echo=FALSE, fig.cap="Our Amazing sponsors and the stunning view from the venue provided by NOUS",echo=FALSE, fig.align="center", out.width = '90%', fig.asp = 0.8}
